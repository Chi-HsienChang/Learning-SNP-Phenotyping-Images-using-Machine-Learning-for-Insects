    ...
    if data['matting']['enable']:
        ...
        if data['black_and_white']['enable']:
            ...
            if data['rotation']['enable']:
                ...
                if data['diameter']['enable']:
                    D(output_path + '_rotation.jpg', output_path + '_diameter.jpg', maximum_diameter) 
                    print(file_name, "processed (MBRD)") 
                else:
                    print(file_name, "processed (MBR)") 
            else:
                if data['diameter']['enable']:
                    D(output_path + '_black_and_white.jpg', output_path + '_diameter.jpg', maximum_diameter) 
            ...
            if data['rotation']['enable']:
                ...
                if data['diameter']['enable']:
                    D(output_path + '_matting.jpg', output_path + '_diameter.jpg', maximum_diameter) 
        ...
        if data['black_and_white']['enable']:
            ...
            if data['rotation']['enable']:
                ...
                if data['diameter']['enable']:
                    D(input_path, output_path + '_diameter.jpg', maximum_diameter) 
