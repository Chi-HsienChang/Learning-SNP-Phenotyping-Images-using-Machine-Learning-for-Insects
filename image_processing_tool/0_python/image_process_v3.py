...
for input_path in input_paths:
    ...
    if data['matting']['enable']:
        M(input_path, output_path + '_matting.jpg')
        if data['black_and_white']['enable']:
            B(output_path + '_matting.jpg', output_path + '_black_and_white.jpg', Blur, L, H)
            if data['rotation']['enable']:
                R(output_path + '_black_and_white.jpg', output_path + '_rotation.jpg', angle, position)
                if data['diameter']['enable']:
                    D(output_path + '_rotation.jpg', output_path + '_DIAMETER_6000.jpg', maximum_diameter) 
                    print(file_name, "processed (MBRD)") 
                else:
                    print(file_name, "processed (MBR)") 
            else:
                if data['diameter']['enable']:
                    D(output_path + '_black_and_white.jpg', output_path + '_DIAMETER_6000.jpg', maximum_diameter) 
                    print(file_name, "processed (MBD)") 
                else:
                    print(file_name, "processed (MB)") 
        else:
            if data['rotation']['enable']:
                R(output_path + '_matting.jpg', output_path + '_rotation.jpg', angle, position)
                if data['diameter']['enable']:
                    D(output_path + '_rotation.jpg', output_path + '_DIAMETER_6000.jpg', maximum_diameter) 
                ...
                if data['diameter']['enable']:
                    D(output_path + '_matting.jpg', output_path + '_DIAMETER_6000.jpg', maximum_diameter) 
                    print(file_name, "processed (MD)") 
                else:
                    print(file_name, "processed (M)") 
    else:
        if data['black_and_white']['enable']:
            B(input_path, output_path + '_black_and_white.jpg', Blur, L, H)
            if data['rotation']['enable']:
                R(output_path + '_black_and_white.jpg', output_path + '_rotation.jpg', angle, position)
                if data['diameter']['enable']:
                    D(output_path + '_rotation.jpg', output_path + '_DIAMETER_6000.jpg', maximum_diameter)
            ...
            if data['rotation']['enable']:
                R(input_path, output_path + '_rotation.jpg', angle, position)
                if data['diameter']['enable']:
                    D(output_path + '_rotation.jpg', output_path + '_DIAMETER_6000.jpg', maximum_diameter)
                ...
                if data['diameter']['enable']:
                    D(input_path, output_path + '_DIAMETER_6000.jpg', maximum_diameter) 
